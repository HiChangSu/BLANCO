...
<div id="cata" class="box2">
	<ul>
		<li><a href="/shoppingmall/list.do?prd_kind=100"> Mac </a> <a
			href="/shoppingmall/list.do?prd_kind=200"> iPad </a> <a
			href="/shoppingmall/list.do?prd_kind=300"> iPhone </a> <a
			href="/shoppingmall/list.do?prd_kind=400"> TimeMarket </a>
	</ul>
</div>
		...
		<c:forEach var="prd" items="${prdList}">
            ...
            구매가능
				...
				<c:if test="${prd.getEnd_time() != null }">
					<tr height="30">
						<td width="350">남은 시간 : <span>${prd.getEnd_time() }</span></td>
					</tr>
				</c:if>
				<c:if test="${prd.getEnd_time() == null }">
					<tr height="30">
